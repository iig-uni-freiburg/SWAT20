...
public class PrecedesTest {
	...
	public void test0() {
		...
		Precedes p1 = new Precedes(new Activity("tIn"), new Activity("tOut"));
	...
	public void test1() {
		IFNet ifnet = IFNetTestUtils.create6PlaceIFNet();
		TransitionToIDMapper.createMap(ifnet);
		Precedes p1 = new Precedes(new Activity("t0"), new Activity("t1"));
		TestUtils tu = new TestUtils(ifnet, p1);
		try {
	...
	public void test2() {
		IFNet ifnet = IFNetTestUtils.create6PlaceIFNet();
		TransitionToIDMapper.createMap(ifnet);
		Precedes p1 = new Precedes(new Activity("t1"), new Activity("td"));
		TestUtils tu = new TestUtils(ifnet, p1);
		try {
			assertFalse(tu.isPropertySatisfied());
		} catch (Exception e) {
	...
	public void test3() {
		...
		TransitionToIDMapper.createMap(ifnet);
		Precedes p1 = new Precedes(new Activity("t1"), new Activity("t3"));
		TestUtils tu = new TestUtils(ifnet, p1);
		try {
			assertFalse(tu.isPropertySatisfied());
		} catch (Exception e) {
