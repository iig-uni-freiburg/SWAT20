...
public class CorequisiteTest {
	...
	public void test0() {
		...
		Corequisite p1 = new Corequisite(new Activity("td"), new Activity("t1"), outputPlace);
	...
	public void test1() {
		...
		Collection<IFNetPlace> outputPlaces = ifnet.getDrainPlaces();
		AbstractPlace<?,?> outputPlace = outputPlaces.iterator().next();
		Corequisite p1 = new Corequisite(new Activity("t1"), new Activity("td"), outputPlace);
		TestUtils tu = new TestUtils(ifnet, p1);
		try {
			assertTrue(tu.isPropertySatisfied());
		} catch (Exception e) {
	...
	public void test2() {
		...
		Collection<IFNetPlace> outputPlaces = ifnet.getDrainPlaces();
		AbstractPlace<?,?> outputPlace = outputPlaces.iterator().next();
		Corequisite p1 = new Corequisite(new Activity("t0"), new Activity("t1"), outputPlace);
		TestUtils tu = new TestUtils(ifnet, p1);
		try {
	...
	public void test3() {
		...
		Collection<IFNetPlace> outputPlaces = ifnet.getDrainPlaces();
		AbstractPlace<?,?> outputPlace = outputPlaces.iterator().next();
		Corequisite p1 = new Corequisite(new Activity("t1"), new Activity("t0"), outputPlace);
		TestUtils tu = new TestUtils(ifnet, p1);
		try {
			assertFalse(tu.isPropertySatisfied());
		} catch (Exception e) {
