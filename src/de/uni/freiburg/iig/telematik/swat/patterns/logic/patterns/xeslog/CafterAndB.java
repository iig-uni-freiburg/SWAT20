...
public class CafterAndB extends LogCompliancePattern {
	...
	public String getName() {
		return "C afer A and B";
	}

	@Override
	public String getDescription() {
		return "C must occur after activity A and B";
	}
	...
	public void setFormalization() {
		...
		RelativeTimeConstraint t_c1 = new RelativeTimeConstraint(timeC, TimeOP.AFTER, t_a, DisplacementOP.PLUS, new TimeDisplacement());
		RelativeTimeConstraint t_c2 = new RelativeTimeConstraint(timeC, TimeOP.AFTER, t_b, DisplacementOP.PLUS, new TimeDisplacement());
