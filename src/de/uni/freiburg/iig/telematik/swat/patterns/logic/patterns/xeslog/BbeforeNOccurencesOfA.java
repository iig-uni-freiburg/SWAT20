...
public class BbeforeNOccurencesOfA extends LogCompliancePattern {

	public BbeforeNOccurencesOfA() {
	...
	public String getName() {
		return "B some time before N occurences of A";
	}

	@Override
	public String getDescription() {
		return "B must occur some time before at least N occurences of A";
	}

	@Override
	public CompliancePattern duplicate() {
		BbeforeNOccurencesOfA duplicate = new BbeforeNOccurencesOfA();
	...
	public final void setFormalization() {
		...
		TimeVariable timeA = new TimeVariable(execA, "start");
		...
		RelativeTimeConstraint t_b = new RelativeTimeConstraint(timeB, TimeOP.BEFORE, timeA, DisplacementOP.PLUS, new TimeDisplacement());
