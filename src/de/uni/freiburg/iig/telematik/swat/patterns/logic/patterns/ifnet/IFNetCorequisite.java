...
import de.uni.freiburg.iig.telematik.swat.patterns.logic.patterns.Corequisite;
import de.uni.freiburg.iig.telematik.swat.patterns.logic.patterns.parameter.Parameter;
import de.uni.freiburg.iig.telematik.swat.patterns.logic.patterns.parameter.ParameterTypeNames;

public class IFNetCorequisite extends Corequisite {
	
	public IFNetCorequisite() {
	...
	public CompliancePattern duplicate() {
		IFNetCorequisite duplicate = new IFNetCorequisite();
	...
	public void setFormalization() {
		...
		mFormalization = "P=? [ ((F(" + operand1 + ")) & (" + "F(" + operand2 + ")) ) | ( (G(!("+ operand1 + "))) & (G(!("+operand2+ "))))]";
	}
