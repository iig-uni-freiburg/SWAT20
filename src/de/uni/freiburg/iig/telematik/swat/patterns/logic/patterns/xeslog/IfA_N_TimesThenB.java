...
public class IfA_N_TimesThenB extends LogCompliancePattern {

	public IfA_N_TimesThenB() {
	...
	public String getName() {
		return "If A N times then B";
	}

	@Override
	public String getDescription() {
		return "If Activity A occured N times then B must occur";
	}

	@Override
	public CompliancePattern duplicate() {
		IfA_N_TimesThenB duplicate = new IfA_N_TimesThenB();
