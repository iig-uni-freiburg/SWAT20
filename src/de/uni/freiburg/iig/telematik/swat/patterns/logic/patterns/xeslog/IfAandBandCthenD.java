...
public class IfAandBandCthenD extends LogCompliancePattern {
	...
	public String getName() {
		return "If A and B and C then D";
	}

	@Override
	public String getDescription() {
		return "If Activity A and B then Activity C and D must occur";
	}
	...
	public void setFormalization() {
		...
		SimpleActivityExecution execC = new SimpleActivityExecution(body, "C", EventType.complete, false);
		...
		SimpleActivityExecution execD = new SimpleActivityExecution(conj, "D", EventType.complete, false);
