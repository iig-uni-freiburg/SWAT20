 ...
 * Besides property changes, the interface also defines methods for the notification about structural changes,<br>
...
public interface PNPropertiesListener {
	...
	/**
	 * This method notifies a PNPropertiesListener that a PN property was changed.
	 * 
	...
	/**
	 * This method notifies a PNPropertiesListener that a PN component was removed.<br>
	 * This can be a place, transition or arc.<br>
	 * 
