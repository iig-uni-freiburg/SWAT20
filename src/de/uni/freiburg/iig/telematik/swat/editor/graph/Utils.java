 ...
 */
	...
	public static void createNodeGraphicsFromStyle(String style, NodeGraphics nodeGraphicsWithPousePosition, AnnotationGraphics annotationGraphics) throws ParameterException {
		...
		annotationGraphics.setFont(new Font(Font.Align.CENTER, null, EditorProperties.getInstance().getDefaultFontFamily(), 0.0, EditorProperties.getInstance().getDefaultFontSize(), "normal",
				"normal"));
