...
public class PTProperties extends PNProperties {
	 ...
	 * @param ptNet The graphical P/T-Net to use.
	 * @throws ParameterException ParameterException If the given net container is <code>null</code>.
	 */
	public PTProperties(GraphicalPTNet ptNet) throws ParameterException{
		super(ptNet);
	}
	...
	/**
	 * Overrides super{@link #getNetContainer()} and returns a {@link GraphicalPTNet}.
	 */
	@Override
