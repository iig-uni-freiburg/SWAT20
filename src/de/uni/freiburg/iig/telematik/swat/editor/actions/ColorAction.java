...
public class ColorAction extends AbstractPNEditorAction{
	public ColorAction(PNEditor editor) throws ParameterException, PropertyException, IOException {
		super(editor, "ColorPanel", IconFactory.getIcon("bg_color"));
	}
