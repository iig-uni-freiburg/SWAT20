...
public class AlignLeftAction extends AbstractPNEditorAction {
	
	public AlignLeftAction(PNEditor editor) throws ParameterException, PropertyException, IOException {
