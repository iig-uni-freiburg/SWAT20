...
public abstract class PNProperties {
	...
	/**
	 * The change support which allows to notify all registered listeners about changes.
	 */
	 ...
	 * The net container is used as underlying Petri net where changes are applied on.<br>
	 ...
	 * This is especially helpful for the {@link PropertiesView} to create enough editing fields.
	 ...
	 * The abstract implementation returns {@link PNProperty#PLACE_LABEL} and {@link PNProperty#PLACE_SIZE}.<br>
	 ...
	 * The set of considered PNProperties is necessarily incomplete, since there are also properties for transitions and arcs.<br>
	 * The abstract implementation returns values for {@link PNProperty#PLACE_LABEL} and {@link PNProperty#PLACE_SIZE}.<br>
	 * Generally, the behavior of this method should be synchronized with the method {@link #getPlaceProperties()}.
	 * @param name The name of the place whose property is requested.
	 * @param property The property which is requested.
	 * @return The value of the desired property of the place with the given name or<br>
	 * <code>null</code> if this property class does not contain a value for the desired property wrt to the given place.
	 * @throws ParameterException If one of the given parameters is <code>null</code> or the net does not contain a place with the given name.
	 * @see PNProperty
	 */
	 ...
	 * Based on the given property, the method chooses an appropriate method for changing the property.<br>
	 * The set of considered PNProperties is necessarily incomplete, since there are also properties for transitions and arcs.<br>
	 * The abstract implementation sets values for {@link PNProperty#PLACE_LABEL} and {@link PNProperty#PLACE_SIZE}.<br>
	 * Generally, the behavior of this method should be synchronized with the method {@link #getPlaceProperties()}.<br>
	 * <br>
	 * This method notifies all listeners about the property change.<br>
	 * Note: The sender of the change request is not notified!
	 * @param sender The object which is requesting a property change.
	 * @param name The name of the place whose property is changed.
	 * @param property The property which is changed.
	 * @param value The new value for the place property.
	 ...
	 * @param placeName The name of the place whose label is requested.
	 * @return The label of the place with the given name.
	 * @throws ParameterException If the given place name is <code>null</code> or the net does not contain a place with the given name.
	 */
	 ...
	 * Note: The sender of the change request is not notified!
	 * @param sender The object which is requesting a label change.
	 * @param placeName The name of the place whose label is changed.
	 * @param label The new label for the place.
	 * @throws ParameterException ParameterException If the given place name is <code>null</code> or the net does not contain a place with the given name.
	 */
	...
	/**
	 * Returns all transition properties which are managed by this properties class.<br>
	 * The abstract implementation returns {@link PNProperty.TRANSITION_LABEL} and {@link PNProperty.TRANSITION_SIZE}.<br>
	 * Subclasses may override this method to add net specific properties.
	 * @return A set of PN properties.
	 * @see PNProperty
	 */
	 ...
	 * The set of considered PNProperties is necessarily incomplete, since there are also properties for places and arcs.<br>
	 * The abstract implementation returns values for {@link PNProperty.TRANSITION_LABEL} and {@link PNProperty.TRANSITION_SIZE}.<br>
	 * Generally, the behavior of this method should be synchronized with the method {@link #getTransitionProperties()}.
	 * @param name The name of the transition whose property is requested.
	 * @param property The property which is requested.
	 * @return The value of the desired property of the transition with the given name or<br>
	 * <code>null</code> if this property class does not contain a value for the desired property wrt to the given transition.
	 * @throws ParameterException If one of the given parameters is <code>null</code> or the net does not contain a transition with the given name.
	 * @see PNProperty
	 */
	@SuppressWarnings("incomplete-switch")
	 ...
	 * Based on the given property, the method chooses an appropriate method for changing the property.<br>
	 * The set of considered PNProperties is necessarily incomplete, since there are also properties for places and arcs.<br>
	 * The abstract implementation sets values for {@link PNProperty.TRANSITION_LABEL} and {@link PNProperty.TRANSITION_SIZE}.<br>
	 * Generally, the behavior of this method should be synchronized with the method {@link #getTransitionProperties()}.<br>
	 * <br>
	 * This method notifies all listeners about the property change.<br>
	 * Note: The sender of the change request is not notified!
	 * @param sender The object which is requesting a property change.
	 * @param name The name of the transition whose property is changed.
	 * @param property The property which is changed.
	 * @param value The new value for the transition property.
	 * @return <code>true</code> if the value was successfully set;<br>
	 * <code>false</code> otherwise.
	 ...
	 * @param transitionName The name of the transition whose label is requested.
	 * @return The label of the transition with the given name.
	 * @throws ParameterException If the given transition name is <code>null</code> or the net does not contain a transition with the given name.
	 */
	 ...
	 * Note: The sender of the change request is not notified!
	 * @param sender The object which is requesting a label change.
	 * @param transitionName The name of the transition whose label is changed.
	 * @param label The new label for the transition.
	 * @throws ParameterException ParameterException If the given transition name is <code>null</code> or the net does not contain a transition with the given name.
	 */
	 ...
	 * Subclasses may override this method to add net specific properties (e.g. arc weight).
	 * @return A set of PN properties.
	 * @see PNProperty
	 */
	 ...
	 * The set of considered PNProperties is necessarily incomplete, since there are also properties for places and transitions.<br>
	 * The abstract implementation always returns <code>null></code>.<br>
	 * Generally, the behavior of this method should be synchronized with the method {@link #getArcProperties()}.
	 * @param name The name of the arc whose property is requested.
	 * @param property The property which is requested.
	 * @return The value of the desired property of the arc with the given name or<br>
	 * <code>null</code> if this property class does not contain a value for the desired property wrt to the given arc.
	 * @throws ParameterException If one of the given parameters is <code>null</code> or the net does not contain an arc with the given name.
	 * @see PNProperty
	 */
	 ...
	 * Based on the given property, the method chooses an appropriate method for changing the property.<br>
	 * The set of considered PNProperties is necessarily incomplete, since there are also properties for places and transitions.<br>
	 * The abstract implementation does not set any value and always returns <code>false</code>.<br>
	 * Generally, the behavior of this method should be synchronized with the method {@link #getArcProperties()}.<br>
	 * <br>
	 * This method notifies all listeners about the property change.<br>
	 * Note: The sender of the change request is not notified!
	 * @param sender The object which is requesting a property change.
	 * @param name The name of the arc whose property is changed.
	 * @param property The property which is changed.
	 * @param value The new value for the arc property.
	 * @return <code>true</code> if the value was successfully set;<br>
	 * <code>false</code> otherwise.
	...
	public String getValue(PNComponent fieldType, String name, PNProperty property) throws ParameterException {
		switch (fieldType) {
		case PLACE:
	...
	public void setValue(Object sender, PNComponent fieldType, String name, PNProperty property, String value) throws ParameterException {
		switch (fieldType) {
		case PLACE:
