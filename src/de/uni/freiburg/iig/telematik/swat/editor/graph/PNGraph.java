...
nodeGraphicsWithPousePosition.setDimension(new Dimension(EditorProperties.getInstance().getDefaultPlaceSize(), EditorProperties.getInstance().getDefaultPlaceSize()));
...
getNetContainer().getPetriNetGraphics().getPlaceGraphics().put(place.getName(), nodeGraphicsWithPousePosition);
getNetContainer().getPetriNetGraphics().getPlaceLabelAnnotationGraphics().put(place.getName(), annotationGraphics);
newCell = insertPNPlace(place, nodeGraphicsWithPousePosition, annotationGraphics);
}
return newCell;
}
...
// */
// public void setPNGraphicsFromCellStates() {
...
//   if(edit instanceof mxGraphModel)
//   System.out.println(((mxGraphModel)edit));
...
// childChange.get
System.out.println(childChange + "#" + name);
System.out.println(childChange.getChild()+"#"+cell.getType() + "#"+childChange.getIndex() + "#" + childChange.getModel() + "#"+childChange.getParent() + "#" + childChange.getPrevious());
// Object prev = childChange.getPrevious();
// 
// mxCell previousCell;
// if (prev != null && prev instanceof mxCell){
// previousCell = (mxCell) cell;
// System.out.println(previousCell.getId() + "#"+previousCell.getStyle()); 
// }
System.out.println(evt.getProperties());
System.out.println(nodeReferences);


switch(cell.getType()){
case PLACE:
if(!getNetContainer().getPetriNet().containsPlace(cell.getId())&& childChange.getPrevious() == null){
try {
if (getNetContainer().getPetriNet().addPlace(cell.getId()) ) {
AbstractPlace place = getNetContainer().getPetriNet().getPlace(cell.getId());
NodeGraphics nodeGraphicsWithPousePosition = new NodeGraphics();
AnnotationGraphics annotationGraphics = new AnnotationGraphics();
nodeGraphicsWithPousePosition.setPosition(new Position(cell.getGeometry().getCenterX(), cell.getGeometry().getCenterY()));
nodeGraphicsWithPousePosition.setDimension(new Dimension(cell.getGeometry().getWidth(), cell.getGeometry().getHeight()));
...
Utils.createNodeGraphicsFromStyle(cell.getStyle(),nodeGraphicsWithPousePosition, annotationGraphics);
