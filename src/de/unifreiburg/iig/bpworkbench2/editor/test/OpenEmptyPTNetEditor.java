...
//	private static void doSomethingFancy(){
//		// Create new JFrame
...
//				String filePath = PNEditor.class.getResource("/samples/samplePTnet.pnml").getPath();
//				
////				/*
////				 * PetriNet
////				 */
//				AbstractGraphicalPN<?, ?, ?, ?, ?, ?, ?> netContainer = new PNMLParser().parse(PNML, true, false);
...
//					panel = new PTNetEditor(file, (GraphicalPTNet) petriNet);
//				}
//
