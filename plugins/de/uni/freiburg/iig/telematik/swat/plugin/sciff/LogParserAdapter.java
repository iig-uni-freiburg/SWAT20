...
public class LogParserAdapter implements ISciffLogReader {
        ...
        public LogParserAdapter(LogView logView) throws ParameterException {
                getSciffTraceList(logView.getTraces());
                logSummary = new LogSummaryAdapter(logView.getSummary());
        }
